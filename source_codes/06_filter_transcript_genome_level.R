#### Command to run tool:
# Rscript /mnt/xvdf/galaxy/tools/myTools/filter_transcript.R --input1 $gmapRes_integrated --input2 $minCoverage --input3 $minIdentity --output1 $filteredTransInfo ;
...
write.table(filteredTransID, file = "/home/chenzhuod/galaxy/database/files/Transcript_evidence/genome_level/filteredTransID", sep = "\t", quote = F, col.names = F, row.names = F)
