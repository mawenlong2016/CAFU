...
do
	...
	/home/chenzhuod/galaxy/tools/CAFU/RSEM-1.3.1/rsem-calculate-expression -p $3 --bowtie2 --bowtie2-path /home/chenzhuod/galaxy/tools/CAFU/bowtie2-2.3.4.3-linux-x86_64 /mnt/xvdf/galaxy/database/files/HISAT/Trimmed_${c0}.fastq $2 ${my}${c0}_exp
